...
const sportLinkSvg = `<?xml version="1.0" encoding="UTF-8"?>
    ...
    >
      <SafeAreaView style={styles.container}>
        <View style={styles.topSection}>
          ...
          <Text style={[styles.slogan, { color: theme.colors.primary }]}>
        ...
        <View style={styles.bottomSection}>
          <View style={styles.centerSection}>
            <View style={styles.optionItem}>
              ...
              <Text style={[styles.optionText, { color: theme.colors.primary }]}>Sevdiğin spor dalında arkadaş bul</Text>
            </View>
            ...
            <View style={styles.optionItem}>
              ...
              <Text style={[styles.optionText, { color: theme.colors.primary }]}>Yakınındaki etkinlikleri keşfet</Text>
            </View>
            ...
            <View style={styles.optionItem}>
              ...
              <Text style={[styles.optionText, { color: theme.colors.primary }]}>Kendi etkinliğini oluştur</Text>
            </View>
          </View>
          ...
          <View style={styles.buttonContainer}>
            ...
            <TouchableOpacity 
              ...
              activeOpacity={0.8}
            >
              <Ionicons name="log-in" size={20} color={theme.colors.primary} style={styles.buttonIcon} />
              <Text style={[styles.loginText, { color: theme.colors.primary }]}>GİRİŞ YAP</Text>
            </TouchableOpacity>
            
            <Text style={[styles.tagline, { color: theme.colors.primary }]}>Sportif Etkinliklerde Buluşmanın En Kolay Yolu</Text>
          </View>
        </View>
      </SafeAreaView>
    </View>
